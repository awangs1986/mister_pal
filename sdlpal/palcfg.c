...
)
{
	...
	/* Lock MiSTer-sim geometry: 320x200 content, 320x240 output with letterbox */
	gConfig.dwScreenWidth = 320;
	gConfig.dwScreenHeight = 240;
	gConfig.dwTextureWidth = 320;
	gConfig.dwTextureHeight = 200;
	gConfig.fKeepAspectRatio = TRUE;
	gConfig.fFullScreen = FALSE;
	gConfig.fEnableGLSL = FALSE;
	fprintf(stderr,
		"PAL_FORCE_240P locked: window 320x240, textureAspect 320x200, KeepAspectRatio=1\n");
#endif
