...
--*/
{
   ...
   while (TRUE)
   {
      ...
      {
         extern int PAL_MisterAuto_ShouldSkipWait(void);
         if (PAL_MisterAuto_ShouldSkipWait())
         {
...
#if defined(__MISTER__)
   {
      extern void PAL_MisterAuto_OnDialogText(const wchar_t* text);
      PAL_MisterAuto_OnDialogText(lpszText);
   }
#endif
