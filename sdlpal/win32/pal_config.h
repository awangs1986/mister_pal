...
/* PAL_FORCE_240P: MiSTer-sim preview — 320x200 content letterboxed in 320x240 */
...
# define PAL_VIDEO_INIT_FLAGS  (SDL_WINDOW_RESIZABLE | (gConfig.fFullScreen ? SDL_WINDOW_FULLSCREEN : 0))
